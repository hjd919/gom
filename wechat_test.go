...
//Serve 处理消息
func (ex *ExampleOfficialAccount) Serve(w http.ResponseWriter, r *http.Request) {
...
func TestWechat_Create(t *testing.T) {
	//获取officialAccount实例
	gomOA := NewGomOA(&GomOAConf{
	...
	http.HandleFunc("/serve", exampleOffAccount.Serve)
